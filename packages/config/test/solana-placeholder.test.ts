/**
 * Tests for the shared Solana placeholder detection utilities exported
 * from @wafflefinance/config.
 *
 * These are the canonical tests; coordinator and relayer tests import the
 * same functions and should produce identical results.
 */
...
} from "../src/solana-placeholder.js";
...
describe("isSolanaPlaceholder — substring / prefix rules", () => {
  it("flags strings containing PLACEHOLDER as a substring", () => {
...
describe("isSolanaPlaceholder — real program addresses", () => {
  ...
  it("returns false for the ATA program", () => {
